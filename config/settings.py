...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "mailer.context_processors.app_settings",
            ],
        },
    },
]
...
APP_NAME = os.environ.get("APP_NAME", "Gmail Batch Mailer")
EMAIL_BATCH_MAX_RECIPIENTS = int(os.environ.get("EMAIL_BATCH_MAX_RECIPIENTS", "100"))
